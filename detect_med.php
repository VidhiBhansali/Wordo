...
$query="select word from medical where frequency='".$frequency."'";
$result = mysql_query($query) or die($query."<br/><br/>".mysql_error());
$row = mysql_fetch_array($result);
$medical = $row['word'];
...
$left_sub5 = $art[$i-4].$space.$art[$i-3].$space.$art[$i-2].$space.$art[$i-1].$space.$medical;	
$right_sub5 = $medical.$space.$art[$i+1].$space.$art[$i+2].$space.$art[$i+3].$space.$art[$i+4];
...
$left_sub4 = $art[$i-3].$space.$art[$i-2].$space.$art[$i-1].$space.$medical;	
...
$left_sub3 = $art[$i-2].$space.$art[$i-1].$space.$medical;	
$right_sub3 = $medical.$space.$art[$i+1].$space.$art[$i+2];
...
$left_sub2 = $art[$i-1].$space.$medical;	
...
if ($total_pmi_sub5f > $total_pmi_5f)
    ...
    $string = $string.$medical.$special.$space;
	}
else 
	{
